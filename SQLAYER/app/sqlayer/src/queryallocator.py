...
from sqlayer import TreeLauncher as TreeLauncher
...
class QueryAllocator:
    ...
    def initialize(self):
        ...
        from sqlayer import QueryProcessor
    ...
    def build_qa_payload(self, node):
        ...
        # Change dmg params for QueryAllocator
        dmg_params                 = copy.deepcopy(self.dmg_params)
    ...
    def unload_qp_response(self, item):
        ...
        print("After json.loads, type(response): ", type(response))
        print(response)
    ...
    def allocate(self):
        ...
        num_threads = min(QueryAllocator.MAX_THREADS, self.dmg.num_allocators)              
        with ThreadPoolExecutor(max_workers=num_threads) as alloc_executor:
            ...
            num_threads = min(QueryAllocator.MAX_THREADS, self.num_partitions)
