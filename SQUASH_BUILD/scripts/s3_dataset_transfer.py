...
def main():
    ...
    # path            = Path('datasets/sift1m_bb512_p20_csuint8_30iter/')
    # path            = Path('datasets/gist1m_bb3840_p10_csuint8_30iter/')
    # path            = Path('datasets/gist1m_bb3840_p20_csuint8_30iter/')
    # path            = Path('datasets/sift10m_bb512_p10_csuint8_30iter/')
    # path            = Path('datasets/sift10m_bb512_p20_csuint8_30iter/')
    # path            = Path('datasets/sift10m_bb512_p40_csuint8_30iter/')
    # path            = Path('datasets/deep10m_bb384_p10_csuint8_30iter/')
