...
class QueryProcessor:
    ...
    def calc_binary_quantization_candidates(self, query_idx):
        ...
        bq_cutoff = np.uint16(np.maximum(bq_cutoff, np.dot((self.dmg.query_k * self.dmg.k_factor), self.dmg.bq_cutoff_perc)))        # Make sure cutoff is > query_k
